...
import { products } from "../../../src/components/base/JS/product-list"
                ...
                {fliteredProductList.map((product, index) => (
                    <div className={`product-card ${fadeAnimation}`} key={index}>
                        ...
                        <div className="product-icons-wrap">
                            <img src='/images/icon/heart.png' alt="" className="product-icon" />
                            <img src='/images/icon/compare.png' alt="" className="product-icon" />
                            <img src='/images/icon/search.png' alt="" className="product-icon" />
                        </div>
                    </div>
                ))}
            </div>
